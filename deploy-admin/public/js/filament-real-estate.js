(function () {
    ...
    function init() {
        ...
        wrapper.innerHTML =
            '<div class="fi-sidebar-group-btn bazar-re-btn" style="display:flex;align-items:center;width:100%;">' +
                '<a href="' + allPropsUrl + '" class="bazar-re-link" style="display:flex;align-items:center;gap:0.5rem;flex:1;min-width:0;text-decoration:none;color:inherit;">' +
                ...
                '</a>' +
                '<button type="button" class="bazar-re-arrow-btn" title="Toggle" style="display:flex;align-items:center;padding:0.25rem;background:none;border:none;cursor:pointer;flex-shrink:0;color:inherit;">' +
                    '<svg class="bazar-re-arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" style="width:1.25rem;height:1.25rem;">' +
