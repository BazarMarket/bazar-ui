export function Squares() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", background: "#f5f5f5", fontFamily: "Poppins, sans-serif" }}>
      <p style={{ fontSize: "12px", color: "#888", marginBottom: "8px" }}>Вариант 1 — 2×2 квадраты</p>
      <div style={gridStyle}>
        ...
        <a href="#" style={highlightStyle}>
          <div style={{ width: 44, height: 44, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <svg width="38" height="38" viewBox="0 0 38 38" fill="none">
              <rect x="3" y="3" width="14" height="14" rx="3.5" fill="#ff9138"/>
              <rect x="21" y="3" width="14" height="14" rx="3.5" fill="#ffb46e"/>
              <rect x="3" y="21" width="14" height="14" rx="3.5" fill="#ffcda0"/>
              <rect x="21" y="21" width="14" height="14" rx="3.5" fill="#ff9138"/>
            </svg>
          </div>
