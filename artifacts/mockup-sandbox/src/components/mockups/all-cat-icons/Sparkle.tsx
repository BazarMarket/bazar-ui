export function Sparkle() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", background: "#f5f5f5", fontFamily: "Poppins, sans-serif" }}>
      <p style={{ fontSize: "12px", color: "#888", marginBottom: "8px" }}>Вариант 4 — Искра / Sparkle</p>
      <div style={gridStyle}>
        ...
        <a href="#" style={highlightStyle}>
          <div style={{ width: 44, height: 44, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <svg width="38" height="38" viewBox="0 0 38 38" fill="none">
              <path d="M19 3C19 3 21 13 27 19C21 25 19 35 19 35C19 35 17 25 11 19C17 13 19 3 19 3Z" fill="#ff9138"/>
              <path d="M3 19C3 19 13 21 19 27C25 21 35 19 35 19C35 19 25 17 19 11C13 17 3 19 3 19Z" fill="#ff9138" opacity=".5"/>
              <circle cx="8" cy="8" r="2" fill="#ff9138" opacity=".3"/>
              <circle cx="30" cy="30" r="2" fill="#ff9138" opacity=".3"/>
            </svg>
          </div>
