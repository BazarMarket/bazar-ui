export function Tag() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", background: "#f5f5f5", fontFamily: "Poppins, sans-serif" }}>
      <p style={{ fontSize: "12px", color: "#888", marginBottom: "8px" }}>Вариант 3 — Тег / Label</p>
      <div style={gridStyle}>
        ...
        <a href="#" style={highlightStyle}>
          <div style={{ width: 44, height: 44, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <svg width="38" height="38" viewBox="0 0 38 38" fill="none">
              <path d="M5 5H20L34 19L20 33L6 19V5Z" fill="#fff4ec" stroke="#ff9138" strokeWidth="2.2" strokeLinejoin="round"/>
              <circle cx="13.5" cy="13.5" r="3" fill="#ff9138"/>
              <path d="M22 16L28 22M18 20L24 26" stroke="#ff9138" strokeWidth="1.8" strokeLinecap="round" opacity=".4"/>
            </svg>
          </div>
...
function PhoneIcon() {
  return (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="fill=#ff9138 none">
