export function Current() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", background: "#f5f5f5", fontFamily: "Poppins, sans-serif" }}>
      <p style={{ fontSize: "12px", color: "#888", marginBottom: "8px", fontFamily: "Poppins, sans-serif" }}>Текущий вариант</p>
      <div style={gridStyle}>
          ...
          <div style={{ width: 44, height: 44, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <svg width="36" height="36" viewBox="0 0 36 36">
              {[0,1,2].map(row => [0,1,2].map(col => (
                <circle key={`${row}-${col}`} cx={6 + col*12} cy={6 + row*12} r="4" fill="#888"/>
              )))}
            </svg>
          </div>
